 ...
 * [fragment_info.OnFragmentInteractionListener] interface
...
class fragment_info : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.tv_info_equipoA.text = "Equipo 1: " + partido.equipo1 + " - Puntuación: " + partido.puntuacion1.toString()
        view.tv_info_equipoB.text = "Equipo 2: " + partido.equipo2 + " - Puntuación: " + partido.puntuacion2.toString()
